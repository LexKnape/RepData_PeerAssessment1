...
```{r The max steps and intervla with max steps }
MaximunSteps <- which.max(StepsPerIntervalAverageClean$mean)
MaximumInterval <- StepsPerIntervalAverageClean$interval [MaximunSteps]
```
